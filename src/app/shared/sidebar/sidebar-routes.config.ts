...
export const ROUTES: RouteInfo[] = [
    ...
    },
    {
        ...
        submenu: [
            {
                path: '/school/all', title: 'Schools', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
            },
            {
                path: '/site/all', title: 'Sites', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
            }
        ]
    },
    {
    ...
    },
    {
        ...
        title: 'Request supervisor change',
        icon: 'ft-layout',
        class: '',
        badge: '',
        badgeClass: '',
