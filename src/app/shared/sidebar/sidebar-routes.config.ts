...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Files', icon: 'ft-align-left', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false,
        submenu: [
    ...
    {
        path: '/chart/all', title: 'Statistic', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    }
